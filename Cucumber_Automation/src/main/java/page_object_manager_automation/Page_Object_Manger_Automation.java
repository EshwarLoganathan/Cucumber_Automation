...
import pom.automation_practice.Dresses_Selection_Page;
...
import pom.automation_practice.Women_Selection_Page;
...
public class Page_Object_Manger_Automation {
	...
	private Women_Selection_Page WSP;
	
	private Dresses_Selection_Page DSP;
	...
	public Women_Selection_Page getWSP() {
		
		if (WSP==null) {
			WSP = new Women_Selection_Page(driver);
			
		}
		return WSP;
	}

	public Dresses_Selection_Page getDSP() {
		
		if(DSP==null) {
			DSP= new Dresses_Selection_Page(driver);
		}
		return DSP;
	}
